...
<div class="container">
    <div class="hero-small bg-primary100 text-center p-6 mb-5">
        <h1 class="display-2 fw-semibold py-1">Perkumpulan Pemuda/i Autisma Yogasmara</h1>
    </div>
    <div class="row mt-3 g-3">
        ...
        <div class="col-4 col-md-2 col-lg-1 ">
            <a href="/artikel/tahun/{{ $item->year }}"
                    ...
                    <div class="berita-text bg-blur-56 position-absolute bottom-0 w-100">
                        <div class="row">
                            ...
                            <div
                                ...
                                <a href="/artikel/{{ $id }}/{{ $item->slug }}" class="text-decoration-none ">
                                    <img src="{{ asset('/images/arrow-right.svg') }}"
                                        class="img-fluid order-last order-sm-first mx-auto d-block " alt="">
                                    <p class="fw-semibold text-center m-0 me-3 me-sm-0">Baca Artikel <br>
                                        Lengkap</p>
                                </a>
